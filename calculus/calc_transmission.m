function transmission = calc_transmission(G_complete, G_channel, H, mu, gen, iter, num, from_id, to_id, per_structs)
%transmission_factor calculate transmission factor from contact 1 to 2
    ...
    for energy=iter.energy.vec
        [green, ~, Gamma, ~] = Green(G_complete, G_channel, energy, H, mu, gen, iter, num, per_structs);
